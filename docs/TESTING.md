...
- Runtime mocks cover the explicit per-turn model, strict schema, required-parameter routing, absence of reasoning fields, malformed roots, metadata preservation, and the unchanged one-request boundary without OpenRouter calls.
